...
def change_password_function(request):
    change_password_form = forms.CustomerChangePasswordForm
    return render(request, 'account/change-password.html', context={'form': change_password_form})
